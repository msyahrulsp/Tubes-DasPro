...
def consum_hist (data):
    # { I.S. : Menerima data dari file csv consumable_history dalam bentuk array }
    # { F.S. : Mencetak data - data dalam file csv consumable_history yang sudah diurutkan menurut tanggal }
